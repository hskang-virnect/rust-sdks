...
## [0.4.10](https://github.com/hskang-virnect/rust-sdks/compare/rust-sdks/livekit-api@0.4.9...rust-sdks/livekit-api@0.4.10) - 2025-11-11

### Added

- add outbound trunk config for create_sip_participant. ([#771](https://github.com/hskang-virnect/rust-sdks/pull/771))
